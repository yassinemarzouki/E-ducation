...
export const routes: Routes = [
  ...
  { path: 'course/:id', loadComponent: () => import('./features/courses/course-detail.component').then(m => m.CourseDetailComponent) },
  { path: 'dashboard', loadComponent: () => import('./features/dashboard/user-dashboard.component').then(m => m.UserDashboardComponent) },
